...
import { authenticate,optionalAuthenticate,authorize}        from '#shared/middlewares/auth.middleware.js';
import { validateRequest }     from '#shared/middlewares/validate.middleware.js';
import { reportSubmitLimiter } from '#shared/middlewares/rate-limit.middleware.js';
import { ReportSchema,  listReportsSchema,  voteReportSchema,reportIdSchema,moderateReportSchema}  from './reports.validator.js';
...
router.patch('/:id/moderate',authenticate,authorize(UserRoles.MODERATOR, UserRoles.ADMIN),validateRequest(reportIdSchema, 'params'),validateRequest(moderateReportSchema, 'body'),reportsController.moderateReport);
